...
- **AI agent actions.** AirMCP enables AI agents to perform actions on your Mac through 266 tools across 27 modules. Any action an AI agent takes through AirMCP is performed on your behalf and at your direction. You are responsible for the outcomes of those actions.
