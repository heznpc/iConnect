...
- **AI agent actions.** AirMCP enables AI agents to perform actions on your Mac through 252 tools across 25 modules. Any action an AI agent takes through AirMCP is performed on your behalf and at your direction. You are responsible for the outcomes of those actions.
